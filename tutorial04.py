...
# Title: tutorial04
# Author: wuhao
# Generated: Tue May 15 16:57:49 2018
##################################################
...
class tutorial04(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, (firdes.low_pass(1,samp_rate,2000,100)), 51500, samp_rate)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((0.00001, ))
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/wuhao/Documents/GRC_examples/ssb_lsb_256k_complex2.dat', True)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.audio_sink_0 = audio.sink(48000, '', True)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1500, 1, 0)
...
def main(top_block_cls=tutorial04, options=None):
